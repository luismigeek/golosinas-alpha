...
if (!empty($_POST)) {
    ...
    if ($db->conectar()) {
        if ($db->deletePresentacion($_POST['id']) == 1) {
            ...
            ?>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    <div class="text-muted">
                        La siguiente presentacion de dulces será eliminada:
                    </div>

                    <pre>
                        <ul>
                            <li><p class="d-inline text-danger">Presentacion: </p> <?php echo $row['GOPRE_DESC'] ?></li>
                        </ul>
                    </pre>
