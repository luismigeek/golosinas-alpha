        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['GOCA_ID']?>">

                    <div class="form-group row">
                        <div class="col-sm-5 m-auto">
                            <input type="text" class="form-control text-center" id="nombre" required name="e_nombre" value="<?php echo $row['GOCA_DESC']?>">
                        </div>
                    </div>
